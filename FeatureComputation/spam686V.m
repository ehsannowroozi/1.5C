...
%--------------------------------------------------------------------------
% We extract the features from last layer of HSV. Spam686V shows the SPAM
% feature with 686 diemnsion on V channel. 
%--------------------------------------------------------------------------
function F = spam686V(IMG)
...
X=rgb2hsv(X);     % Convert to HSV and then compute the features from luminance layer
X=X(:,:,3);       % seperate last layer of luminance channel
